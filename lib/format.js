...
/**
 * Provenance label for every byte prediction derived from MODERN_FORMAT_RATIO.
 * The ratios below are uncalibrated heuristics for prioritization, not promises
 * of quality-equivalent measured savings. Do not invent numeric confidence
 * ranges for them without a calibration dataset.
 */
export const ESTIMATE_KIND_HEURISTIC = 'heuristic-estimate';

/** Human-readable companion to ESTIMATE_KIND_HEURISTIC for rows and summaries. */
export const ESTIMATE_NOTE =
  'Opportunities are heuristic estimates for prioritization, not measured savings.';
 ...
 * It checks a `format=` style CDN parameter before the path extension, because
 * the parameter often changes the response behind a legacy file name.
 *
 * @param {string} url
